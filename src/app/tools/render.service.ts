...
export class RenderService {
  ...
  async renderSVG(SVGid: number, SVGElement: ElementRef): Promise<any> {
  ...
  async compileSVGImage(compiledImage: BehaviorSubject<string>, SVGid: number, SVGElement: ElementRef): Promise<any> {
    await compiledImage.next(compiledImage.getValue().concat('<g class="' + SVGid +  '">'));
  ...
  async compileSVGLayers(compiledImage: BehaviorSubject<string>, generatedItemsLayers: GeneratedItemLayer[]): Promise<any> {
  ...
  async paintSVGToElement(SVGElement: ElementRef,compiledImage: BehaviorSubject<string>) {
